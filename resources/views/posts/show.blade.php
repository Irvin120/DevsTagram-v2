        ...
        <div class="md:w-1/2">
            ...
            @auth
                @if ($post->user_id === auth()->user()->id)
                    {{-- //no creamos el safdelete que cambie a visible lo invisible --}}
                    <form action="{{ route('posts.destroy', $post) }}" method="POST">
                        @csrf
                        {{-- Metogo spofee el navegador soporta Get y Post --}}
                        @method('DELETE')
                ...
                @auth
                    ...
                    <form action="{{ route('comentarios.store', ['post' => $post, 'user' => $user]) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="comentario" name="comentario" placeholder="Agregue un Comentario"
